<template>
  <footer :class="$style.footer">
    <p>&copy; {{ new Date().getFullYear() }} Momuflix Media Studio. All rights reserved. <a target="_blank" href="https://jason.codes/cookie-policy" rel="noopener">Cookie Policy</a>.</p>
    <p>Develop by Aitek Mobile & Web Development <a target="_blank" href="https://www.themoviedb.org/" rel="noopener">TMDb</a>.</p>
